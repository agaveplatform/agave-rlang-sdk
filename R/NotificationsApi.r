...
#'
#' ```
#` notificationss$addNotification$$listNotifications(body, naked, )
#` ```
#'
#'
...
#'
#' ```
#` notificationss$deleteNotification$$listNotifications(uuid, naked, )
#` ```
#'
#'
...
#'
#' ```
#` notificationss$getNotification$$listNotifications(uuid, naked, )
#` ```
#'
#'
...
#'
#' ```
#` notificationss$listNotifications$$listNotifications(associatedUuid, naked, limit, offset, search, )
#` notificationss$listNotifications$$listNotifications(search=list("foo"="bar"))
#` ```
#'
#'
...
#'
#' ```
#` notificationss$updateNotification$$listNotifications(uuid, body, naked, )
#` ```
#'
#' }
#'
